        ...
        function(err, res) {
          ...
          function respondWithCss(css, importedFileNames) {
            ...
            async.eachLimit(
              importedFileNames,
              10,
              function(importedFileName, cb) {
                fs.stat(
                  importedFileName,
                  passError(cb, function(stats) {
              ...
              passError(sendErrorResponse, function() {
                ...
                if (oldETag) {
                  ...
                  if (importedFileNames.length) {
                    ...
                    importedFileNames
                      .sort()
                      .forEach(function(importedFileName) {
          ...
          res
            ...
            .on('end', function() {
              ...
              if (isOldLessApi) {
                ...
                parser.parse(
                  lessText,
                  passError(sendErrorResponse, function(root) {
                    var css;
                    try {
                ...
                less.render(
                  lessText,
                  lessOptions,
                  passError(sendErrorResponse, function(output) {
